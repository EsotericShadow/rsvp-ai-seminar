    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-300 mt-1">Detailed RSVP submissions and attendee data</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="glass rounded-xl p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-neutral-300">Total Attendees</p>
        ...
        <div className="glass rounded-xl p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-neutral-300">Want Resources</p>
        ...
        <div className="glass rounded-xl p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-neutral-300">Want Audit</p>
