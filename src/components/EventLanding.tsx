      ...
      <motion.header initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, ease: EASE }} className="pt-5 sm:pt-8">
        <div className="mx-auto flex justify-center px-4">
          <Link
            ...
            target="_blank"
            rel="noreferrer"
              className="relative flex items-center rounded-xl border border-gray-200 bg-white shadow-sm transition hover:border-brand-sage/40 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brand-sage w-full max-w-3xl h-auto"
            >
