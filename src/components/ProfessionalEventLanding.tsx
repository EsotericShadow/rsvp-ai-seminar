      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <motion.div 
            ...
            className="lg:col-span-2"
          >
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl shadow-xl border border-emerald-100 overflow-hidden">
              <div className="bg-gradient-to-r from-emerald-600 to-teal-600 px-8 py-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-100">Insights on AI for Northern BC businesses</p>
                  </div>
                </div>
                </div>
                ...
                <div className="p-8">
                  <div className="space-y-6">
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900 mb-4">AI ≠ Chatbots</h3>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        And here's the good news: you don't need to be in Silicon Valley to use it. Businesses across Northern BC can tap into AI today, affordably, practically, and with real results.
                      </p>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-6 border-t border-emerald-100">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center">
                          <span className="text-emerald-600 font-bold text-lg">GM</span>
                        </div>
                        <div>
                          <p className="font-semibold text-gray-900">Gabriel Marko</p>
                          <p className="text-sm text-gray-500">AI/Machine Learning Engineer</p>
                        </div>
                      </div>
                    ...
                    <Link
                      ...
                      className="block w-full bg-emerald-600 text-white text-center py-4 px-6 rounded-xl font-semibold text-lg hover:bg-emerald-700 transition-colors duration-200 focus:outline-none focus:ring-4 focus:ring-emerald-200"
                    >
                      Read Full Article →
                    </Link>
                  </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Thursday, October 23, 2025</p>
                      <p className="text-sm text-gray-600">6:00 PM - 8:30 PM</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Sunshine Inn Terrace</p>
                      <p className="text-sm text-gray-600">4812 Hwy 16, Terrace, BC</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Coffee & refreshments included</p>
                    </div>
                  </div>
                </div>
              </div>
