...
async function createAIEventTemplates() {
  console.log('🔍 Creating AI Event email templates...');
  
  // Clean up any existing AI event templates
  ...
  console.log('🧹 Cleaned up existing AI event templates');
  
  const templates = [
    // Email 1 - Initial Invitation (September 25, 2025)
    {
      name: 'Initial Invitation A',
  ...
  for (const template of templates) {
    ...
    console.log(`✅ Created: ${newTemplate.name} (Email ${template.emailNumber} - ${template.variant})`);
  }

  console.log('\n🎉 All AI event email templates created successfully!');
  console.log('📊 Summary:');
