...
<head>
    ...
    <style>
        ...
        .evergreen-logo{width:72px;height:72px;margin:8px auto;display:inline-block;}
        .evergreen-logo img{width:100%;height:100%;object-fit:contain;}
            ...
            <tbody>
                ...
                <tr>
                    <td class="evergreen-header" style="padding-top:22px;padding-bottom:8px;">
                        ...
                        <div class="evergreen-logo" aria-hidden="true">
                            <img src="https://rsvp.evergreenwebsolutions.ca/logo.svg" alt="Evergreen Web Solutions" />
                        </div>
                    </td>
                </tr>
