...
async function categorizeBatch1() {
  console.log('🎯 CATEGORIZING BATCH 1 (First 100 businesses)')
  console.log('==============================================')
  ...
  try {
    ...
    console.log(`\n📊 BATCH 1 CATEGORIZATION RESULTS:`)
    ...
    console.log(`\n📊 CURRENT TOTALS AFTER BATCH 1:`)
    updatedGroups.forEach(group => {
      console.log(`- ${group.name}: ${group._count.members} businesses`)
    })
    
    console.log(`\n✅ Batch 1 categorization complete!`)
    
  } catch (error) {
    console.error('❌ Failed to categorize batch 1:', error)
    throw error
  } finally {
